setwd("C://Users/pc/Documents/Магистратура/2 семестр/R/task5 ДР")
getwd()
...
# Здесь:
# my_tree - дерево решений
# cex (character extension) - размер символов
...
# Добавим названия столбцов
# colnames(predict)<- c('V2','V3','V4','V5','V6','V8','V9','V10','V11','V12','V13','V14','V15','V16','V17','V19','V20','V21','V22','V23','V24','V25','V26','V27','V28','Type')
